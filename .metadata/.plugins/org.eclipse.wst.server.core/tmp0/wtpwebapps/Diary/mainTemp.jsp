...
<body >
	<div class="navbar navbar-inverse navbar-fixed-top" >
		...
		<div class="container">
			<div class="row-fluid">
				<div class="span9">
					<jsp:include page="${mainPage }"></jsp:include>	<%--页面引入 --%>
				</div>
				<div class="span3">
					<div class="data_list">
						...
						<div class ="datas">
							<ul>
								<c:forEach var="diaryType" items ="${diaryTypeCountList }">
									<li><span><a href="main?s_diaryTypeId=${diaryType.diaryTypeId }">${diaryType.typeName }(${diaryType.diaryTypeCount })</a></span></li>
								</c:forEach>
							</ul>
						</div>
					</div>
