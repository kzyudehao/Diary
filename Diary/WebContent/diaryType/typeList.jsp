...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>	<%--引入日期标签 --%>
		...
		<div>
			<table class="table table-hover table-striped">
  				...
  				<c:forEach var="diaryType" items="${diaryTypeList }">
  					<tr>
  						<th>${diaryType.diaryTypeId }</th>
  						<th>${diaryType.typeName }</th>
  						<th>
  							<button class="btn btn-mini btn-primary" type="button" onclick="javascript:window.location='diaryType?action=preSave&diaryTypeId=${diaryType.diaryTypeId }'">修改</button>
